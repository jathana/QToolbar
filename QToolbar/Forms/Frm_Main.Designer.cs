namespace QToolbar
{
   partial class Frm_Main
   {
      ...
      private void InitializeComponent()
      {
         ...
         this.mnuPlugins = new DevExpress.XtraBars.BarSubItem();
         ...
         this.btnMinimizeApp = new DevExpress.XtraBars.BarButtonItem();
         ...
         this.imageCollection1.InsertGalleryImage("ide_16x16.png", "images/programming/ide_16x16.png", DevExpress.Images.ImageResourceCache.Default.GetImage("images/programming/ide_16x16.png"), 4);
         this.imageCollection1.Images.SetKeyName(4, "ide_16x16.png");
         // 
         // btnOptions
         // 
         ...
         // mnuDesigners
         // 
         this.mnuDesigners.Caption = "Designers (ClickOnce)";
         ...
         // mnuPlugins
         // 
         this.mnuPlugins.Caption = "Plugins";
         this.mnuPlugins.Id = 32;
         this.mnuPlugins.ImageOptions.Image = ((System.Drawing.Image)(resources.GetObject("mnuPlugins.ImageOptions.Image")));
         this.mnuPlugins.ImageOptions.LargeImage = ((System.Drawing.Image)(resources.GetObject("mnuPlugins.ImageOptions.LargeImage")));
         ...
         // btnCloseApp
         // 
         this.btnCloseApp.Caption = "Close";
         this.btnCloseApp.Id = 6;
         this.btnCloseApp.ImageOptions.LargeImage = ((System.Drawing.Image)(resources.GetObject("btnCloseApp.ImageOptions.LargeImage")));
         this.btnCloseApp.Name = "btnCloseApp";
         // 
         // btnMinimizeApp
         // 
         this.btnMinimizeApp.Caption = "Minimize";
         this.btnMinimizeApp.Id = 7;
         this.btnMinimizeApp.ImageOptions.LargeImage = ((System.Drawing.Image)(resources.GetObject("btnMinimizeApp.ImageOptions.LargeImage")));
         ...
         // grpApplications
         // 
         this.grpApplications.ItemLinks.Add(this.mnuDesignersLocal);
      ...
      private DevExpress.XtraBars.BarSubItem mnuPlugins;
      ...
      private DevExpress.XtraBars.BarButtonItem btnMinimizeApp;
   }
}